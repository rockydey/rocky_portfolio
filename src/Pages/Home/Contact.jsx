...
const Contact = () => {
    return (
        <div className='my-16 lg:mx-20 mx-5'>
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-10 mt-8'>
                ...
                <div className='my-8 mx-auto lg:mx-0'>
                    ...
                    <form action="">
                        <input className='border-b-2 rounded-xl py-6 pl-5 md:pr-56 pr-10 mb-3' type="text" placeholder='Enter your name' /><br />
                        ...
                        <textarea className='border-b-2 rounded-xl py-6 pl-5 md:pr-56 pr-10 mb-3' name="" id="" cols="24" rows="2" placeholder='Enter your message'></textarea><br />
                        <button type="submit" className='btn btn-primary text-white font-semibold px-8 text-xl tracking-wider'>Submit</button>
                    </form>
                </div>
            </div>
        </div>
