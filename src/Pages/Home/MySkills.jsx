...
const MySkills = () => {
    return (
        <div className='my-16 mx-5 md:mx-20' id='myskill'>
            ...
            <div className=' grid md:grid-cols-2 grid-cols-1 gap-10 lg:mx-20 mt-8'>
                <div>
                    ...
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "95%" }}></div>
                    </div>
                </div>
                <div>
                    <h4 className='font-semibold'>CSS3</h4>
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "90%" }}></div>
                    </div>
                </div>
                <div>
                    <h4 className='font-semibold'>JavaScript</h4>
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "80%" }}></div>
                    </div>
                </div>
                <div>
                    <h4 className='font-semibold'>Bootstrap</h4>
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "85%" }}></div>
                    </div>
                </div>
                <div>
                    <h4 className='font-semibold'>Tailwind</h4>
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "83%" }}></div>
                    </div>
                </div>
                <div>
                    <h4 className='font-semibold'>React</h4>
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "75%" }}></div>
                    </div>
                </div>
                <div>
                    <h4 className='font-semibold'>Firebase</h4>
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "73%" }}></div>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "68%" }}></div>
                    </div>
                </div>
                <div>
                    <h4 className='font-semibold'>MongoDB</h4>
                    <div className="w-full bg-gray-200 h-2 rounded mb-6">
                        <div className="bg-primary rounded h-2" style={{ width: "65%" }}></div>
                    </div>
                </div>
            </div>
        </div>
